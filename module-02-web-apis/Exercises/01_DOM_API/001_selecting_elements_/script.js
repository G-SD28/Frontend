...
// document.querySelector(".hero-content : last-child").textContent = "Open daily from 7 AM to 9 PM.";

// newPara.style.backgroundColor = "red";
// newPara.style.padding = "0 .5rem";
// newPara.style.borderRadius = "1rem";

// heroContent.appendChild(newPara);  // appendChild , add 1 thing
heroContent.append(newPara); // append is more flexible (and modern), can add more than one.
